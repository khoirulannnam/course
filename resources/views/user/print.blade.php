                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="table-responsive ">
                                        <table class="table table-borderless">
                                            <thead>
                                                <tr>
                                                    <th style="padding-x:25px">Name</th>
                                                    <th style="padding-x:15px">Instagram</th>
                                                    <th style="padding-x:15px">Date</th>
                                                    <th style="padding-x:15px">Team</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td style="padding-x:25px">{{$data->name}}</td>
                                                    <td style="padding-x:25px">{{$data->instagram}}</td>
                                                    <td style="padding-x:25px">{{$data->date}}{{$data->reservation}}:00 WIB</td>
